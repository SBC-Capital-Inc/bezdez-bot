...
echo 
echo -e ${ANSI_BG_BLUE}"Checking out to $GIT_MAIN_BRACH branch locally..."${ANSI_OFF}
git checkout $GIT_MAIN_BRACH

echo 
echo -e ${ANSI_BG_BLUE}"Pulling $GIT_MAIN_BRACH branch from remote..."${ANSI_OFF}
git pull origin $GIT_MAIN_BRACH
